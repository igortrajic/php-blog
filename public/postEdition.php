    ...
    <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <form action="#" class="space-y-6">
            <div>
                ...
                <input type="text" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-blue-50/50 focus:border-blue-500 transition-all outline-none" placeholder="Edit title">
            </div>
            <div>
